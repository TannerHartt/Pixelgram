...
pipeline {
    ...
    stages  {
        ...
        stage("build-image") {
            ...
            steps {
                sh 'docker build . -t enablementprojects/capybaras-fems:latest'
            }
        }
        ...
        stage("push-image") {
            ...
            steps {
                sh 'docker push enablementprojects/capybaras-fems'
            }
 	    }
        ...
        stage("deploy-image") {
            ...
            steps {
                sh 'kubectl rollout restart deployment/capybaras-fems --namespace=capybaras'
            }
         }
    }
