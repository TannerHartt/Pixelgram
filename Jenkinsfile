...
pipeline {
    ...
    stages  {
        ...
        stage("build-image") {
            ...
            steps {
                sh 'docker build . -t enablementprojects/capybaras-ui:latest'
            }
        }
        stage("push-image") {
            when {
            ...
            steps {
                sh 'docker push enablementprojects/capybaras-ui'
            }
        }
        stage("deploy-image") {
            when {
            ...
            steps {
                sh 'kubectl rollout restart deployment/capybaras-ui --namespace=capybaras'
            }
         }
    }
    post {
