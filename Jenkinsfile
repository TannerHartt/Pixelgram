...
pipeline {
    ...
    stages  {
        ...
        stage("build-image") {
            ...
            steps {
                sh 'docker build . -t enablementprojects/capybaras-comment:latest'
            }
        }
        ...
        stage("push-image") {
            ...
            steps {
                sh 'docker push enablementprojects/capybaras-comment'
            }
 	    }
        ...
        stage("deploy-image") {
            ...
            steps {
                sh 'kubectl rollout restart deployment/capybaras-comment  --namespace=capybaras'
            }
         }
    }
